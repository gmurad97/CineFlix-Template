...
import { TMDB_LARGE_POSTER_BASE_URL, TMDB_ORIGINAL_POSTER_BASE_URL } from "../../utils/constants";
import { StringToDate } from "../../utils/helpers";
import { Link } from "react-router-dom";

const MovieSingle = ({ movieId }) => {
                ...
                <div className="movie-single__information">
                    ...
                    <div className="movie-single__about">
                        <div className="movie-single__about-rate">
                            ...
                            <span className="movie-single__about-rate-value">{movieData.vote_average}</span>
                        </div>
                    ...
                    <div className="movie-single__details-buttons">
                        <button className="movie-single__view-trailer-btn" type="button">
